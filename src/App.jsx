...
// Lazy-loaded modules (réduit initial bundle)
const Analytics      = lazy(() => import('./modules/Analytics.jsx'));
const Boutiques      = lazy(() => import('./modules/Boutiques.jsx'));
const ProduitsStock  = lazy(() => import('./modules/ProduitsStock.jsx'));
const PointDeStock   = lazy(() => import('./modules/PointDeStock.jsx'));
const Orders         = lazy(() => import('./modules/Orders.jsx'));
